...
const GraphInfoSection: React.FC<GraphInfoSectionProps> = ({ activeGraph, boundaryYear }) => (
  <>
    ...
    <div className={styles.comment}>
      ※グラフツール:
      <a href="https://recharts.org/en-US/" target="_blank" rel="noopener noreferrer" className={styles.externalLink}>
        Recharts
      </a>
    </div>
  </>
